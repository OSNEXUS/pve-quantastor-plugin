...
my $api_storage_config = sub {
	PVE::Storage::LunCmd::QuantaStorPlugin::qs_write_to_log("Config.pm - api_storage_config");
    my ($cfg, $storeid) = @_;
...
sub cleanup_storages_for_node {
	PVE::Storage::LunCmd::QuantaStorPlugin::qs_write_to_log("Config.pm - cleanup_storages_for_node");
...
sub create_or_update {
	PVE::Storage::LunCmd::QuantaStorPlugin::qs_write_to_log("Config.pm - create_or_update");
...
__PACKAGE__->register_method ({
    ...
    code => sub {
	PVE::Storage::LunCmd::QuantaStorPlugin::qs_write_to_log("Config.pm - create methode code");
	my ($param) = @_;
