...
sub zfs_parse_zvol_list {
    my ($text, $pool) = @_;
    PVE::Storage::LunCmd::QuantaStorPlugin::qs_write_to_log("ZFSPoolPlugin.pm - zfs_parse_zvol_list - called with (text: '$text', pool: '$pool')");
...
sub list_images {
    ...
    PVE::Storage::LunCmd::QuantaStorPlugin::qs_write_to_log("ZFSPoolPlugin.pm - list_images - vmid: $vmid, storeid: $storeid");
...
sub zfs_list_zvol {
    my ($class, $scfg) = @_;
    PVE::Storage::LunCmd::QuantaStorPlugin::qs_write_to_log("ZFSPoolPlugin.pm - zfs_list_zvol");
